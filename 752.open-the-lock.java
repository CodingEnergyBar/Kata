...
public class Solution {
     ...
     */
    // corner case start is inside deadset
    //
    public int openLock(String[] deadends, String target) {
        ...
        while (!queue.isEmpty()) {
            ...
            // first get the size and then poll
            ...
            for (int i = 0; i < size; i++) {
                ...
                // all the queue poll is inside of the loop
                for (String s : getNextSteps(cur)) {
    ...
    String[] getNextSteps(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            int next = (n + 1) % 10;
            String r = s.substring(0, i) + next + s.substring(i + 1);
            res.add(r);

            next = (n - 1 + 10) % 10;
            r = s.substring(0, i) + next + s.substring(i + 1);
            res.add(r);
        }

        return res.toArray(new String[8]);
    }
}
// @lc code=end
